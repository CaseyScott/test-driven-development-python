...
def get_change(amount, coins=eur_coins):
    ...
    'coins' is the set of coins that we need to get change for (the set of
    available coins)
    ...
    # 'sorted' to sort the order
    #starting with the lowest by default, use 'reverse=True' to start 
    #with the highest denomination
    #The 'while' ends when the domination quantity reaches 0.
...
text_exception_was_raised(get_change,(5, {2: 1, 1: 2}),"Insufficient coins to give change.")
