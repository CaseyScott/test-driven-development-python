...
def text_exception_was_raised(func, args, message):
    """
    ...
    'args' is a tuple containing the arguments that are to be provided to 'func'
    'message' is the string that is expected to be output by the error once it's thrown
    """
    try:
        #Call the function and unpack the 'args' tuple by using '*'.
        #This will unpack each of the items from the 'args' tuple to pass
        #them into the function as arguments
        func(*args)
        
        #Execution will cease at this point if the error was successfully thrown,
        #and will move onto the 'except' block.
        #If the function was sucessfully executed without throwing an error, 
        #we'll raise an AssertionError here to inform the developer that the
